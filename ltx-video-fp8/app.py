"""LTX-Video 2B distilled FP8 I2V (sibling of ltx-video/).

Same official Lightricks multi-scale stack, but:
- checkpoint: ltxv-2b-0.9.8-distilled-fp8.safetensors
- no prompt-enhancer models in pipeline.yaml
...
app = FastAPI(title="ltx-video-2b-distilled-fp8", lifespan=lifespan)
...
def health():
    ...
    return {
        ...
        "backend": "lightricks-ltx-video-fp8",
        "precision": (pipeline_config or {}).get("precision"),
